...
{*/
	if(isset($_POST['submit']))
	{
		...
		$sql = "INSERT INTO tbl_branch(branch_name)value('$branch_name')";
	...
	if(isset($_POST['des_submit']))
	{
		$designation_name = $_POST['designation_name'];
		$advance_limit = $_POST['advance_limit'];
		$sql = "INSERT INTO tbl_designation(designation_name,advance_limit)value('$designation_name','$advance_limit'";
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=" treeview">
		 ...
		 <li class=" treeview">
          <a href="refill_advance.php">
            <i class="fa fa-dashboard"></i> <span>Refill Advance</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
