...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="staff_dashboard.php" class="logo">
      ...
      <span class="logo-lg"><b>Staff | Records</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" class="btn btn-default btn-flat">Record</a>
                </div>
...
<div id="designationModal" class="modal fade" role="dialog">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" name="des_submit" class="btn btn-default">Submit</button>
    </div>
  </div>
</form>
      </div>
